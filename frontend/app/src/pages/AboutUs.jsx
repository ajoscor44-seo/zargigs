...
const AboutUs = () => {
  const data = [
    {
      title: "Welcome to Zargigs",
      description:
        "Welcome to Zargigs. Zargigs is a dynamic platform designed to connect users with a wide range of earning opportunities. Whether you're looking to complete simple tasks, promote products, or engage in various online activities, Zargigs provides a user-friendly environment to help you achieve your financial goals.",
    },
    {
      title: "Our Mission",
      description:
    ...
    },
    {
      title: "Join Us",
      description:
        "Become a part of the Zargigs community and start earning today. Whether you're a task creator looking to promote your business or a task performer seeking new opportunities, Zargigs is here to support you.",
    },
    {
      title: "Contact Us",
