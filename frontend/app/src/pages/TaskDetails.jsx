    ...
    try {
      ...
      if (data && !data.failed) {
        ...
        setTaskDetails({
          ...
          caption: data.caption || `Promote with Zargigs on ${resolvedPlatform}. Earn daily income! Register: https://zargigs.com`,
          link: data.link || data.action_link || (resolvedPlatform === "facebook" ? "https://facebook.com" : "https://zargigs.com"),
      ...
      setTaskDetails({
        ...
        caption: `Check out Zargigs! Monetize your social media and earn daily cash. Join here: https://zargigs.com #Zargigs`,
        link: fallbackPlatform === "facebook" ? "https://facebook.com" : "https://zargigs.com",
