      ...
      <div className="flex flex-col items-center mt-5 gap-10 p-3">
        ...
        <div className="grid grid-flow-col gap-3 items-start">
          ...
          <div>
            ...
            <p className="font-medium text-sm font-primary mt-2 pr-2">
              Access our vast network of social media users ready to engage with
              your content. From likes and shares to posting your adverts, our
              members are here to help spread your message.
            </p>
          </div>
        </div>
        <div className="grid grid-flow-col gap-3 items-start">
          <div className="service_icon border p-4 rounded-full">
            <img className="w-8 h-8" src={postAdvertImg} alt="postAdvertImg" />
          </div>
          ...
          <div>
            ...
            <p className="font-medium text-sm font-primary mt-2 pr-2">
              Our platform promotes organic growth and engagement. By connecting
              with real users across various social media platforms, your brand
              gains authentic visibility and credibility.
            </p>
          </div>
        </div>
        <div className="grid grid-flow-col gap-3 items-start">
          ...
          <div>
            ...
            <p className="font-medium text-sm font-primary mt-2 pr-2">
              Enjoy flexible advertising solutions tailored to your budget. With
              GigsFlix, you pay only for genuine interactions, ensuring your
              investment brings maximum returns.
            </p>
          </div>
        </div>
        <div className="grid grid-flow-col gap-3 items-start">
          ...
          <div>
            ...
            <p className="font-medium text-sm font-primary mt-2 pr-2">
              Launching your campaign is simple and straightforward. Choose your
              desired actions (likes, shares, advert postings), set your budget,
